...
*Validates basic functionality and API endpoints*
```bash
...
#### 2. Load Test
*Establishes baseline performance under normal conditions*
```bash
...
#### 3. Stress Test  
*Finds your application's breaking point*
```bash
...
#### 4. Spike Test
*Tests behavior during sudden traffic increases*
```bash
...
export const config = {
  ...
  thresholds: {
    load: { /* load test thresholds */ },
    stress: { /* stress test thresholds */ },
    // ... per test type
  }
}
```
